...
public class ArraySort<E> {
  ...
  public void mergeSort(E[] data, Comparator<? super E> compare) {
    ...
    data = mergeSort(compare, splitLeft(data), splitRight(data));
  }
 ...
 */
  private E[] splitRight(E[] array) {
    ...
    for (int i = (int) (array.length / 2); i < array.length; i++) {
      output[i] = array[i - (int) (array.length / 2)];
    }
    return output;
 ...
 * @param compare: this will be used to compare the values in the array
 */
